...
import nitx.c14230224.mynavigation.databinding.FragmentDetailProfileBinding
import nitx.c14230224.mynavigation.databinding.FragmentProfileBinding
...
class DetailProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentDetailProfileBinding.inflate(
            inflater,
            container,
            false
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding!!.tvParam.text = param1.toString()

            val dataTerima = DetailProfileFragmentArgs.fromBundle(arguments as Bundle).dataSatu
            binding!!.tvParamSafeArgs.text = dataTerima.toString()
    }
